# Port Number Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:portnumberlookup-api:1.1.12'
}
```
...
```java
import com.apiverve.portnumberlookup.PortNumberLookupAPIClient;
import com.apiverve.portnumberlookup.APIResponse;
import com.apiverve.portnumberlookup.APIException;

// Initialize the client
PortNumberLookupAPIClient client = new PortNumberLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/portnumberlookup](https://docs.apiverve.com/ref/portnumberlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/portnumberlookup](https://docs.apiverve.com/ref/portnumberlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/portnumberlookup-api/issues)
