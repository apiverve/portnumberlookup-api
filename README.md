...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/portnumberlookup](https://docs.apiverve.com/ref/portnumberlookup)

---

## Use Cases

Common use cases for the Port Number Lookup API:
