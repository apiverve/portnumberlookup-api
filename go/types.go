...
// Request contains the parameters for the Port Number Lookup API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"port": {Type: "integer", Required: true, Min: float64Ptr(1), Max: float64Ptr(65535)},
	}
...
// ResponseData contains the data returned by the Port Number Lookup API.
