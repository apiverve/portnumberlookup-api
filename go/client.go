// Package portnumberlookup provides a Go client for the Port Number Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/portnumberlookup?utm_source=go&utm_medium=readme
package portnumberlookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/portnumberlookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Port Number Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Port Number Lookup API client.
...
// Execute makes a request to the Port Number Lookup API with typed parameters.
//
...
//   - port (required): integer - Port number to lookup [min: 1, max: 65535]
