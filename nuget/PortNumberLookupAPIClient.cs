...
namespace APIVerve.API.PortNumberLookup
{
    ...
    /// <summary>
    /// Client for the PortNumberLookup API
    /// </summary>
    public class PortNumberLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/portnumberlookup";
        ...
        {
            { "port", new ValidationRule { Type = "integer", Required = true, Min = 1, Max = 65535 } }
        };
        ...
        public PortNumberLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PortNumberLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PortNumberLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PortNumberLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PortNumberLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(PortNumberLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PortNumberLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PortNumberLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PortNumberLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PortNumberLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PortNumberLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PortNumberLookupQueryOptions options)
        {
