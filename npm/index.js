...
class portnumberlookupWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/portnumberlookup');
        }
        ...
        this.validationRules = {"port":{"type":"integer","required":true,"min":1,"max":65535}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/portnumberlookup`);
        }
    }
...
module.exports = portnumberlookupWrapper;
